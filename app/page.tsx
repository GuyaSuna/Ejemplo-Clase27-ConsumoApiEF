  ...
  return (
    <main className="pagina">
      <header className="encabezado">
        ...
        <p>
          Ejemplo de consumo de la API <code>/api/turnos</code>.
        </p>
      </header>
        ...
        <section className="tarjeta formulario">
          ...
          <form onSubmit={guardarTurno}>
            ...
            <input
              ...
              onChange={(e) =>
                actualizarCampo("nombrePaciente", e.target.value)
              }
            />
            ...
            <label className="check">
              <input
                ...
                onChange={(e) =>
                  actualizarCampo("confirmado", e.target.checked)
                }
              />{" "}
              Turno confirmado
            </label>
          ...
          {turnos.length === 0 ? (
            ...
            <ul>
              {turnos.map((turno) => (
                <li key={turno.id}>
                  <div>
                    <strong>{turno.nombrePaciente}</strong>
                    <p>
                      {turno.especialidad} ·{" "}
